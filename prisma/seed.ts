  ...
  await prisma.$transaction(async (transaction) => {
        ...
        fields: {
          fields: [
            ...
            },
            {
              ...
              type: "text",
              required: false,
              helpText: "Leave blank if the learner has not attended a school.",
            },
          ],
        },
      },
    ...
    const dashboardItems = [
      ...
      },
      {
        ...
        description: "Attach objectives and the formative assessment activity.",
      ...
      },
      {
        ...
        description: "Teacher-curated revision notes for the next assessment.",
        studentProfileId: "student_profile_demo",
        sectionId: "section_cbse_pune_8a_demo",
      },
      {
